...
if __name__ == '__main__':
    ...
    processor.get_passage_answer(data_root, 'cmrc2018_train.json', 'train')
    processor.get_passage_answer(data_root, 'cmrc2018_dev.json', 'dev')
    processor.get_passage_answer(data_root, 'cmrc2018_trial.json', 'trial')
